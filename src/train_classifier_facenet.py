...
parser.add_argument("--embeddings", default = "./embeddings/facenet/embs_class_train_160x160_20180402-114759.csv", help = "path to file index embeddings for train")
...
if __name__ == '__main__':
    ...
    model.save("./models/facenet//model_" + args.model + "_" + str(args.size) + ".h5")
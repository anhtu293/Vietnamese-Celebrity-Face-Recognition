...
parser.add_argument("--embeddings", default = "./embeddings/insight/embs_class_train_112x112_model-r50-am-flw.npy", help = "path to file index embeddings for train")
...
if __name__ == '__main__':
    ...
    model.save("./model/insight/" + args.model + "/model_" + args.model + "_" + args.size + ".h5")